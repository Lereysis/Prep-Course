...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var numeroAuxiliar = numeros[0];
	for ( var i = 0; i < numeros.length; i++) {
    	if (numeros[i] >= numeroAuxiliar) {
...
function mesesDelAño(array) {
  ...
  // Tu código:
  // var meses = array.filter( function(elemento){
...
function breakStatement(numero) {
  ...
  while ( i < 10 ) {
    numero = numero + 2;
    if (numero === i) {
       mensajeError = 'Se interrumpió la ejecución'
       break;
    }
    array[i] = numero;
    i++
  }
  return mensajeError || array
